  ...
  <div class="container mt-5 d-flex flex-column align-items-center">
    <div class="section mb-5" :id="sectionIdsRef.brand">
      ...
      <div class="content text-justify">
        <p>
          探索時尚新境界，我們不僅提供韓國女裝，更是引領潮流的先鋒。從日常休閒到正式場合，我們精心挑選的款式讓您無論何時何地都閃耀自信。我們的設計師團隊不斷追求創新，確保您永遠走在時尚前沿。不僅如此，我們還注重品質與舒適度的結合，讓您在時尚之中感受到無比的舒適。透過我們的電子商務平台，您可以輕鬆選購心儀的款式，踏上獨特的時尚之旅。無論您是風格獨特還是追求流行，我們都擁有完美的選擇，期待與您一同探索美麗與時尚的世界！
        </p>
      </div>
    </div>
    ...
    <div class="section mb-5" :id="sectionIdsRef.shoppingProcess">
      ...
      <div class="content text-justify">
        ...
        <p><strong>2. 點擊產品圖片：</strong> 進入詳細頁面，仔細了解更多產品信息。</p>
        <p><strong>3. 加入購物車：</strong> 將所需產品添加到購物車中，然後繼續結帳流程。</p>
        <p>
          <strong>4. 送出訂單：</strong>
          在訂單頁面填寫送貨地址、姓名、電話及電子信箱，確認後點擊“送出訂單”按鈕。
        </p>
        <p>
          <strong>5. 結帳付款：</strong>
          在結帳頁面進入結帳流程，即完成訂單，我們將立即為您安排出貨。
        </p>
      </div>
    </div>
    ...
    <div class="section mb-5" :id="sectionIdsRef.paymentMethods">
      ...
      <div class="content text-justify">
        <p>
          <img src="/src/assets/img/icons/nav.svg" alt="nav" width="0.75rem" height="0.75rem" class="me-1">
          我們接受多種付款方式，包括信用卡、PayPal、支付寶等。
        </p>
        <p>
          <img src="/src/assets/img/icons/nav.svg" alt="nav" width="0.75rem" height="0.75rem" class="me-1">
          所有付款信息均經過安全加密，保障您的個人資訊安全。
        </p>
      </div>
    </div>
    <img src="@/assets/img/icons/hr.svg" alt="hr" class="img-fluid my-5">
    <div class="section mb-5" :id="sectionIdsRef.shippingService">
      ...
      <div class="content text-justify">
        <p>
          <img src="/src/assets/img/icons/nav.svg" alt="nav" width="0.75rem" height="0.75rem" class="me-1">
          我們提供全球送貨服務，運送到您指定的地址。
        </p>
        <p>
          <img src="/src/assets/img/icons/nav.svg" alt="nav" width="0.75rem" height="0.75rem" class="me-1">
          部分地區可能有額外運費或運送時效，請在結帳頁面查看詳細信息。
        </p>
      </div>
    </div>
    <img src="@/assets/img/icons/hr.svg" alt="hr" class="img-fluid my-5">
    <div class="section" :id="sectionIdsRef.returnPolicy">
      ...
      <div class="content text-justify">
        <p>
          <img src="/src/assets/img/icons/nav.svg" alt="nav" width="0.75rem" height="0.75rem" class="me-1">
          如果您對購買的產品不滿意，您可以在 30 天內申請退換貨。
        </p>
        <p>
          <img src="/src/assets/img/icons/nav.svg" alt="nav" width="0.75rem" height="0.75rem" class="me-1">
          請確保商品未被使用且保留原包裝，以確保您的退換貨申請被受理。
        </p>
      </div>
    </div>
    <img src="@/assets/img/icons/hr.svg" alt="hr" class="img-fluid my-5">
